...
import { ShoppingBag, BarChart3, Apple, Zap, ChevronRight, Bell, LogOut, Menu, X } from 'lucide-react'
...
function buildNav(slug: string) {
  return [
    { href: `/grocery/${slug}/orders`,    label: 'Orders',      icon: ShoppingBag },
    { href: `/grocery/${slug}/products`,  label: 'My Products', icon: Apple },
    { href: `/grocery/${slug}/analytics`, label: 'Analytics',   icon: BarChart3 },
  ]
}

export default function GroceryPartnerSidebar({ partner }: { partner?: PartnerInfo }) {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-[#E5E7EB]">
        ...
        <div>
          ...
          <div className="text-[10.5px] text-[#6B7280] font-medium">Grocery Partner Portal</div>
        </div>
      </div>
      ...
      <div className="px-3 pb-3 border-t border-[#E5E7EB] pt-3">
        <div className="flex items-center gap-3 px-3 py-3 bg-[#F8FAFC] rounded-xl">
          ...
          <div className="min-w-0">
            ...
            <div className="text-[11px] text-[#9CA3AF]">Grocery Partner</div>
          </div>
